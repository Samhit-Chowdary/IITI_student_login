...
<body>
<header><center><h3>Add Course</h3></center></header><br><br>
<%
...
try {
    ...
    Stmt.executeUpdate("insert into course value('"+request.getParameter("acid")+"','"+request.getParameter("acn")+"','"
    +request.getParameter("ad")+"','"+request.getParameter("ac")+"','"+request.getParameter("al")+"','"+
    request.getParameter("at")+"','"+request.getParameter("ap")+"')");
